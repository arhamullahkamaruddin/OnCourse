                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-12">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay="0.2s">Platform<br> Pembelajran Online</h1>
                                <p data-animation="fadeInLeft" data-delay="0.4s">Kembangkan keterampilan Anda dengan kursus, sertifikat, dan
                                    gelar online dari universitas dan perusahaan terkemuka di dunia</p>
                                <a href="{{ route('login') }}" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Bergabunglah secara gratis</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="support-wrapper align-items-center">
            <div class="left-content1">
                ...
                <div class="single-features">
                    ...
                    <div class="features-caption">
                        <p>Teknik untuk berinteraksi secara efektif dengan anak-anak dan remaja yang rentan.</p>
                    </div>
                </div>
                <div class="single-features">
                    <div class="features-icon">
                ...
                <div class="single-features">
                    ...
                    <div class="features-caption">
                        <p>Bergabunglah dengan jutaan orang dari seluruh dunia yang belajar bersama. Belajar online sama mudahnya dan
                            alami.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="support-wrapper align-items-center">
            ...
            <div class="left-content3">
                ...
                <div class="section-tittle section-tittle2 mb-20">
                    <div class="front-text">
                        <h2 class="">Hasil belajar pada kursus yang akan Anda ambil</h2>
                    </div>
                </div>
                <div class="single-features">
                    <div class="features-icon">
    ...
    <section class="about-area2 fix pb-padding">
        <div class="support-wrapper align-items-center">
            <div class="right-content2">
                <!-- img -->
                <div class="right-img">
                    <img src="guest-template/assets/img/gallery/about2.png" alt="">
                </div>
            </div>
            <div class="left-content2">
                ...
                <div class="section-tittle section-tittle2 mb-20">
                    <div class="front-text">
                        <h2 class="">Ambil langkah selanjutnya
                            menuju tujuan pribadi
                            dan profesional Anda
                            bersama kami.</h2>
                        <p>Proses otomatis untuk semua tugas situs web Anda. Temukan alat dan teknik untuk berinteraksi secara efektif
                            dengan anak-anak dan remaja yang rentan.</p>
                        <a href="{{ route('register') }}" class="btn">Daftar Sekarang Gratis</a>
                    </div>
                </div>
            </div>
        </div>
