...
<body>
    ...
    <main class="login-body" data-vide-bg="user-template/assets//img/login-bg.mp4">
        ...
        <form class="form-default" action="{{ route('login.submit') }}" method="POST">
            ...
            <div class="login-form">
                ...
                <div class="logo-login">
                    <a href="{{ route('home') }}"><img src="user-template/assets//img/logo/loder.png" alt=""></a>
                </div>
                <h2>Login Disini</h2>
                ...
                <a href="{{ route('register') }}" class="registration">Registrasi</a>
    ...
    <!-- Video bg -->
    <script src="./user-template/assets//js/jquery.vide.js"></script>
